...
class RotatedStandardRoIHead(BaseModule, metaclass=ABCMeta):
    ...
    def __init__(self,
        ...
        #self.weights = torch.nn.Parameter(torch.ones(self.bbox_head.num_classes+1) * 0.01)
    ...
    def init_cls_bbox_head(self, cls_bbox_roi_extractor,cls_bbox_head):
        """Initialize ``bbox_head``.
        ...
        Args:
            ...
            bbox_head (dict): Config of ``bbox_head``.
        """
        self.cls_bbox_roi_extractor = build_roi_extractor(cls_bbox_roi_extractor)
        self.cls_bbox_head = build_head(cls_bbox_head)   
