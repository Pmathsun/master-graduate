...
class OriCrossEntropyLossWithMaxDiffAndEntropy(CrossEntropyLoss):
    def __init__(self, use_sigmoid=False, use_mask=False, reduction='mean', 
        ...
        # 设置更稳定的初始权重
        self.lambda_ce = torch.tensor(0.8) # 交叉熵损失的权重
        self.lambda_max_diff =  torch.tensor(0.2)  # 最大差异损失的权重
        self.lambda_entropy =  torch.tensor(0.2)  # 熵损失的权重
