...
from .max_diff_cross_entropy_loss import CrossEntropyLossWithMaxDiffAndEntropy
from .ori_max_diff_cross_entropy_loss import OriCrossEntropyLossWithMaxDiffAndEntropy
__all__ = [
    'GDLoss', 'GDLoss_v1', 'KFLoss', 'ConvexGIoULoss', 'BCConvexGIoULoss',
    'KLDRepPointsLoss', 'SmoothFocalLoss', 'RotatedIoULoss',
    'SpatialBorderLoss','CrossEntropyLossWithMaxDiffAndEntropy','OriCrossEntropyLossWithMaxDiffAndEntropy'
]
