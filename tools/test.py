...
def parse_args():
    ...
    #parser.add_argument('--config', default='/home/ssy/mmrotate/configs/oriented_rcnn/feature_oriented_rcnn_r50_fpn_1x_dota_le90.py',help='test config file path')
    parser.add_argument('checkpoint', help='checkpoint file')
    #parser.add_argument('--checkpoint', default='/home/ssy/mmrotate/logs/deform_conv/epoch_1.pth',help='checkpoint file')
    parser.add_argument(
        '--work-dir',
